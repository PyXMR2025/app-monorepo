...
/** Test seam — enumerate registered impls without loading them. */
export function listRegisteredSignerImpls(): string[] {
  return Object.keys(SIGNER_LOADERS);
}

/** Narrow helper for factory call sites that already have a walletKind. */
export type IAuthWalletKindWithBuilder = Extract<
  AuthWalletKind,
  keyof ISignerBuilders
>;
